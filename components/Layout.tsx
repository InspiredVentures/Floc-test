...
export const Layout: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-background shadow-2xl relative">
            <div className="mx-auto flex h-screen max-w-7xl flex-col overflow-hidden border-x border-primary/5 bg-background shadow-2xl relative">
                ...
                {showNav && (
                    <div className="sticky bottom-0 z-50 w-full">
                        <nav className="mx-auto max-w-7xl bg-white/90 dark:bg-background-dark/95 backdrop-blur-xl border-t border-slate-200 dark:border-white/10 px-6 pt-3 pb-8 flex justify-between items-center">
                            <button
                                onClick={() => { navigate('/my-communities'); setIsPowerMenuOpen(false); }}
                                className={`flex flex-col items-center gap-1 transition-colors relative ${isActive('/my-communities') ? 'text-primary' : 'text-slate-400 hover:text-white'}`}
                            >
                            ...
                            <button
                                ...
                                className={`flex flex-col items-center gap-1 transition-colors ${isActive('/discover') ? 'text-primary' : 'text-slate-400 hover:text-white'}`}
                            >
                            ...
                            <button
                                ...
                                className={`flex flex-col items-center gap-1 transition-colors ${isActive('/global-feed') ? 'text-primary' : 'text-slate-400 hover:text-white'}`}
                            >
                            ...
                            <button
                                ...
                                className={`flex flex-col items-center gap-1 transition-colors ${isActive('/profile') ? 'text-primary' : 'text-slate-400 hover:text-white'}`}
                            >
