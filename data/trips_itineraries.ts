...
export const TRIP_CONTENT: { [key: string]: TripContent } = {
    ...
    'bhutan': {
        ...
        itinerary: [
            ...
            { day: '07', title: 'Tiger’s Nest Monastery', desc: "Complete the journey with the iconic hike to Taktshang (Tiger’s Nest), revered as Bhutan's most sacred spiritual site. Celebrate the achievement with a traditional hot-stone bath at a local farmhouse.", image: '/images/trips/bhutan-tigers-nest.jpg' },
