        ...
        <div className="bg-white rounded-[1rem] p-8 text-background-dark shadow-2xl space-y-8 font-serif">
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed text-slate-700">
              Community Leaders are the ultimate guardians of member safety during physical ventures. This includes, but is not limited to, the verification of local transport, high-quality medical kits, and reliable emergency communication channels (sat-comms).
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed text-slate-700">
              Leaders must maintain professional conduct on the Pulse feed and in private Community chats. Any form of discrimination or unethical promotion will result in immediate dissolution of the Community and permanent suspension of the Leader.
            </p>
          </section>
